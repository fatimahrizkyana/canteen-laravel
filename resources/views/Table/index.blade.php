...
<div class="row">
    <div class="col-6 offset-3 mt-3">
        <a href="{{ route('table.create') }}" class="btn btn-outline-dark float-right">
            <i class="fa fa-plus" aria-hidden="true"></i>Tambah
        </a>
        <h5 style="margin-top: 9px;">Data Meja</h5>
    </div>
            ...
            <table class="table table-striped table-bordered text-center" style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('table.edit', ['table' => $table->id]) }}" class="btn btn-outline-success btn-sm" >
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Hapus data meja nomor "{{ $table->number }}" ?</h5>
